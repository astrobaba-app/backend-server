...
io.engine.on("connection", (rawSocket) => {
  console.log("Engine transport:", rawSocket.transport.name);
...
const kundliReportRoute = require("./routes/horoscope/kundliReportRoute");
const astroInsightRoute = require("./routes/horoscope/astroInsightRoute");
...
const feedbackRoute = require("./routes/feedback/feedbackRoute");
...
app.use("/api/astro-insights", astroInsightRoute);
app.use("/api/horoscope", dailyHoroscopeRoute);
app.use("/api/kundli-matching", kundliMatchRoute);
app.use("/api/kundli-report", kundliReportRoute);
...
// server can reject Socket.IO's /socket.io websocket upgrade requests.
