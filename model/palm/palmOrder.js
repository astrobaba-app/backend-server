...
const PalmOrder = sequelize.define(
  "PalmOrder",
  {
    ...
    retriesUsed: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
    lastFailureReason: { type: DataTypes.STRING, allowNull: true },
    retryExhaustedAt: { type: DataTypes.DATE, allowNull: true },
    retrySourceOrderId: { type: DataTypes.UUID, allowNull: true },
  },
  {
